  ...
  return (
    <div className="contact-page d-flex">
      <div className="contact-page-new">
        <div className="contact-left-section mobile-dis">
          <h2 className="color-pink mb-2">Get in touch</h2>
          <p className="mb-2">
          ...
          <p className="mb-2">Call Us: 07067981819</p>
          <p className="mb-2">
        ...
        <div className="mobile-seen">
          <p className="color-pink mb-1">Share on</p>
          <div className="ml-ng-1 social-media">
      ...
      <div className="contact-right-section">
        <p className="color-pink">Questions or need assistance?</p>
        <p className="color-pink mb-2">Let us know about it</p>
